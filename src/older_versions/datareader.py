...
if __name__ == '__main__':
    ...
    train_dataset = TLESSDataset(root='./data/tless', split='train_render_reconst',step="train") #[0:10]
    print('num_imgs test dataset:',len(train_dataset))
    val_dataset = TLESSDataset(root='./data/tless', split='train_primesense',step="val", ind= val_index.indices)  #[0:10]
